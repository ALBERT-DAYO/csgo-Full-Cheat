...
namespace Offset {
	...
	inline DWORD LocalPlayerPawn = 0x16D4F48;
	inline DWORD ForceJump = 0x16CE390;
	inline DWORD EntityList = 0x17CE6A0;
	inline DWORD Matrix = 0x182CEA0;
	inline DWORD64 ViewAngle = 0x1890F30;
	inline DWORD LocalPlayerController = 0x181DC98;
	inline DWORD64 EntityListEntry;
	inline DWORD64 LocalPawn;
